...
export default function RecipientsTable() {
    ...
    if (error) return <div>Error loading recipients list</div>
    if (!data) {
        return <div>Loading</div>
    } else if (data.message !== "Successfully fetched list!") return <div>Error loading recipients list</div>
            ...
            <div className="overflow-auto max-h-[50vh] shadow-[0_3px_10px_-1px_rgba(0,0,0,1)]">
                <div className="min-w-full table text-gray-900">
                    <div className="table-header-group text-left text-sm font-normal">
                        <div data-testid="table-head-recipients" className="table-row bg-neutral-800/45 text-neutral-300">
                            <div className="table-cell border-b border-black text-left px-4 py-5 font-bold sm:pl-6">
                                Recipients
                            </div>
                        </div>
                    </div>
                    <div data-testid="table-body-recipients" className="table-row-group">
