...
func TestReceiveMail(t *testing.T) {
	...
	mockDb.On("GetApprovalFromListName", "sender@domain.tld", "list1").Return(1, true, nil)
	mockDb.On("GetApprovalFromListName", "sender@domain.tld", "list2").Return(2, false, nil)
